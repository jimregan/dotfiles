% Last Modified: Thu Feb 23 14:44:18 2017 (vogel) 
...
test(18) :- s([some,people,introduces,some,dog,to,some,cat],[]).
test(19) :- s([some,people,introduces,some,dog,some,cat],[]).

testem :-
     pass([1,2,3,4,8,10,11,13,14,16]),
     fail([5,6,7,9,12,15,17,18,19]).
